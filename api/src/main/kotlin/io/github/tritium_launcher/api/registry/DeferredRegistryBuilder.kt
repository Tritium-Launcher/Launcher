 ...
 * the complete set (e.g., file type matchers) and should not render partial state while
...
class DeferredRegistryBuilder<T: Registrable>(
    ...
    private val logger = LoggerFactory.getLogger(DeferredRegistryBuilder::class.java)

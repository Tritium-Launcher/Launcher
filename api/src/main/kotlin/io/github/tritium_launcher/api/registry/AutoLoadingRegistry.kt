...
/**
 * Thread safe registry that can integrate [ServiceLoader] provider discovery.
 */
class AutoLoadingRegistry<T : Any, P : Any>(
     ...
     *
     * If null, no [ServiceLoader] behavior is available for the registry.
     */
    ...
    private val logger = LoggerFactory.getLogger(AutoLoadingRegistry::class.java)

 ...
 *
 * This structure is owned by [io.github.tritium_launcher.launcher.settings.SettingsMngr] and is responsible for enforcing
 * namespace ownership, parent-child category constraints, and uniqueness rules.
 *
 * @see io.github.tritium_launcher.launcher.settings.SettingsMngr

...
data class MenuItem(
    ...
    val shortcutActionId: String? = null,
    val allowKeyboardShortcuts: Boolean = true,
    val allowMouseShortcuts: Boolean = true,
    val shortcutFocusGroups: Set<String> = setOf("global"),
